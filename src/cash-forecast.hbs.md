...
1. **Pin the workspace.** {{> define-workspace purpose="to project your cash position forward"}}

2. **Confirm the connections this answer needs.** {{> connect-tools purpose="to project your cash position forward" kinds="bank" required="bank" internalCheck=true}}
