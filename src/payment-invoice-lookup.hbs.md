...
1. **Pin the workspace.** {{> define-workspace purpose="to match payments against invoices"}}

2. **Confirm the connections this answer needs.** {{> connect-tools purpose="to match payments against invoices" kinds="bank, invoicing, accounting" internalCheck=true}}
...
6. **Normalize currency.** {{> normalize-currency}}
