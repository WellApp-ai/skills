...
| `assign-missing-invoices` | "Assign these expenses to someone" — the card expenses still missing an invoice for a month, split into unassigned and already yours, each assignable to a person from the card. | [View details →](docs/assign-missing-invoices.md) |
...
1. Fetch these files:
    ...
    aa. https://raw.githubusercontent.com/WellApp-ai/skills/refs/heads/main/skills/assign-missing-invoices/SKILL.md
...
| `assign-missing-invoices` | The card expenses missing an invoice for a month, split into unassigned and already yours, each assignable to a person from the card. | [⬇ Download for Claude Desktop](https://github.com/WellApp-ai/skills/raw/main/dist/assign-missing-invoices.skill) · [.zip](https://github.com/WellApp-ai/skills/raw/main/dist/assign-missing-invoices.zip) |
