...
2. Call `well_get_skill({ skill: "show-missing-invoices" })` and follow the returned document exactly. It is the authoritative instruction set; do not substitute your own plan for it.
