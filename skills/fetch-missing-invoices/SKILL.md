...
**Thin list.** `empty`, `transaction_count: 0` → say the list rests on 0 categorized transactions, ask whether to categorize first; on yes, step 6's batches, one re-read at step 7, preview at step 8 on the go.
