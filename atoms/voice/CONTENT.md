---
name: voice
description: The house tone every Well skill answers in. Plain, short, understated sentences with a fixed word list and no writing tells. Dev-only test artifact, never installed by end users.
---
