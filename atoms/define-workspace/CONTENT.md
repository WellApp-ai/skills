...
description: Resolve which Well workspace (or workspaces) a conversation works in, and hand it off as a typed result. Dev-only test artifact — never installed by end users.
placeholders:
