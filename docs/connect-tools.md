...
[⬇ Install connect-tools](https://github.com/WellApp-ai/skills/raw/main/dist/connect-tools.skill) and open the downloaded file. Desktop installs the skill straight away, with nothing to unzip.
