...
[⬇ Install normalize-currency](https://github.com/WellApp-ai/skills/raw/main/dist/normalize-currency.skill) and open the downloaded file. Desktop installs the skill straight away, with nothing to unzip.
