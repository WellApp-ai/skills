...
[⬇ Install define-period](https://github.com/WellApp-ai/skills/raw/main/dist/define-period.skill) and open the downloaded file. Desktop installs the skill straight away, with nothing to unzip.
