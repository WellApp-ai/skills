...
[⬇ Install assign-missing-invoices](https://github.com/WellApp-ai/skills/raw/main/dist/assign-missing-invoices.skill) and open the downloaded file. Desktop installs the skill straight away, with nothing to unzip.
