...
[⬇ Install deploy-agents](https://github.com/WellApp-ai/skills/raw/main/dist/deploy-agents.skill) and open the downloaded file. Desktop installs the skill straight away, with nothing to unzip.
