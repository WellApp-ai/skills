...
[⬇ Install connect-bank](https://github.com/WellApp-ai/skills/raw/main/dist/connect-bank.skill) and open the downloaded file. Desktop installs the skill straight away, with nothing to unzip.
