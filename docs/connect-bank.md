...
**Get the bank feed into Well in one click — and know whether it is actually live.**
...
- **Banking connector** (a Plaid institution or a native bank such as Qonto) — *checked, connected here if missing.*
- **Accounting and invoicing connectors** — *not read here.* Use `connect-tools` for those.
...
[⬇ Download for Claude Desktop](https://github.com/WellApp-ai/skills/raw/main/dist/connect-bank.skill) · [.zip](https://github.com/WellApp-ai/skills/raw/main/dist/connect-bank.zip)
