...
[⬇ Install connect-accounting](https://github.com/WellApp-ai/skills/raw/main/dist/connect-accounting.skill) and open the downloaded file. Desktop installs the skill straight away, with nothing to unzip.
